...
describe('Shell', () => {
  it('renders without crashing', () => {
    renderShell();
    expect(screen.getByText('Null Bank')).toBeDefined();
  });
  ...
  it('renders placeholder for accounts route', () => {
    ...
    expect(screen.getByText('Accounts — coming soon')).toBeDefined();
  });

  it('renders placeholder for customers route', () => {
    renderShell('/customers');
    expect(screen.getByText('Customers — coming soon')).toBeDefined();
  });

  it('renders placeholder for transfers route', () => {
    renderShell('/transfers');
    expect(screen.getByText('Transfers — coming soon')).toBeDefined();
  });

  it('shows default message on unmatched route', () => {
    renderShell('/unknown');
    expect(screen.getByText('Select a domain from the sidebar')).toBeDefined();
  });
});
